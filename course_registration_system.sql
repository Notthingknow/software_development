...
(2, 1002, '微處理機', 3, '資訊三乙', '(五)3', '資電402', 80, 10, '9002', '本課程介紹微處理機系統結構, 記憶體元件, 記憶體介面, I/O設備, I/O介面, 以及I/O方法之Polling I/O, Interrupt I/O, DMA I/O。'),
(3, 1003, '網路程式設計', 2, '資訊三合', '(二)7', '資電104', 60, 38, '9003', '介紹各種主從式架構下網路程式設計及實作技巧'),
(4, 1004, '軟體工程開發實務', 3, '資訊三合', '(三)6', '工319', 60, 3, '9004', '介紹軟體工程基本的原則與觀念。學生修習此課後可以學習到軟體工程紀律、專案管理、需求、設計、測試、版本管理及軟體維護等基本觀念。學生可以透過操作軟體工程工具的方式學習這些概念。'),
(5, 1005, '實用職場英文', 2, '資訊三乙', '(四)6', '資電104', 62, 1, '9005', '「實用職場英文」以提升學生職場英語能力為主軸，採取互動及務實的教學方式，著重培養學生在職場所須之溝通技巧。課程架構涵蓋口說與寫作訓練，除了求職所需之英語能力外，亦針對進入職場後所需之英語溝通技巧。'),
(6, 1006, '3D動畫實作與歷史建物永續I', 2, '科技知識原理與趨勢浪潮', '(一)11', '土302', 40, 1, '9006', '虛擬實境共分成三大類，分別是影像式虛擬實境、幾何式虛擬實境與混合式虛擬實境，而不論是哪種類型，3D模型的建立都是最基礎的過程。本課程將透過對知名或歷史建物的3D描繪，去學習繪製的技術及瞭解建物落成的歷'),
(7, 1007, '消費權益與生活素養', 2, '人文藝術與社會經典教育', '(四)11', '商201', 76, 3, '9007', '介紹消者保護理念與法律思維，並以實例研討方式，說明消費權益保護的相關議題，學習日常生活中所涉網路交易、電視購物、不實廣告、定型契約、產品責任、消費申訴等問題處理知能。同時加強同學們對本課程與各種社會脈'),
...
(9, 1002, '微處理機', 3, '資訊三乙', '(五)4', '資電402', 80, 10, '9002', '本課程介紹微處理機系統結構, 記憶體元件, 記憶體介面, I/O設備, I/O介面, 以及I/O方法之Polling I/O, Interrupt I/O, DMA I/O。'),
(10, 1003, '網路程式設計', 2, '資訊三合', '(二)8', '資電104', 60, 38, '9003', '介紹各種主從式架構下網路程式設計及實作技巧'),
(11, 1004, '軟體工程開發實務', 3, '資訊三合', '(三)7', '工319', 60, 3, '9004', '介紹軟體工程基本的原則與觀念。學生修習此課後可以學習到軟體工程紀律、專案管理、需求、設計、測試、版本管理及軟體維護等基本觀念。學生可以透過操作軟體工程工具的方式學習這些概念。'),
(12, 1004, '軟體工程開發實務', 3, '資訊三合', '(三)8', '工319', 60, 3, '9004', '介紹軟體工程基本的原則與觀念。學生修習此課後可以學習到軟體工程紀律、專案管理、需求、設計、測試、版本管理及軟體維護等基本觀念。學生可以透過操作軟體工程工具的方式學習這些概念。'),
(13, 1005, '實用職場英文', 2, '資訊三乙', '(四)7', '資電104', 62, 1, '9005', '「實用職場英文」以提升學生職場英語能力為主軸，採取互動及務實的教學方式，著重培養學生在職場所須之溝通技巧。課程架構涵蓋口說與寫作訓練，除了求職所需之英語能力外，亦針對進入職場後所需之英語溝通技巧。'),
(14, 1006, '3D動畫實作與歷史建物永續I', 2, '科技知識原理與趨勢浪潮', '(一)12', '土302', 40, 1, '9006', '虛擬實境共分成三大類，分別是影像式虛擬實境、幾何式虛擬實境與混合式虛擬實境，而不論是哪種類型，3D模型的建立都是最基礎的過程。本課程將透過對知名或歷史建物的3D描繪，去學習繪製的技術及瞭解建物落成的歷'),
(15, 1007, '消費權益與生活素養', 2, '人文藝術與社會經典教育', '(四)12', '商201', 76, 3, '9007', '介紹消者保護理念與法律思維，並以實例研討方式，說明消費權益保護的相關議題，學習日常生活中所涉網路交易、電視購物、不實廣告、定型契約、產品責任、消費申訴等問題處理知能。同時加強同學們對本課程與各種社會脈'),
(16, 2996, '韓文(一)', 2, '應用外語選修', '(一)1', '語206', 68, 5, '9008', ''),
(17, 2996, '韓文(一)', 2, '應用外語選修', '(一)2', '語206', 68, 5, '9008', ''),
(18, 876, '資訊安全與生活', 2, '創能學院綜合班', '(一)3', '圖213', 60, 2, '9009', ''),
(19, 876, '資訊安全與生活', 2, '創能學院綜合班', '(一)4', '圖213', 60, 2, '9009', '');
...
(5, '(五)3', '1002', 'D1018734'),
(8, '(五)4', '1002', 'D1018734'),
(10, '(二)8', '1003', 'D1018734'),
(11, '(三)7', '1004', 'D1018734'),
(12, '(三)8', '1004', 'D1018734'),
(42, '(一)3', '1001', 'D1018734'),
(43, '(一)4', '1001', 'D1018734');
